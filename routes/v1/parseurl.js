...
//shopclues
    ...
    function getImages() {
        ...
        if (website_detected == 'elitify') {
            ...
            if( main_image == '' || more_images.length == 0){
                // added by arun on 9th july 2015, as snpadeal websites design changed
                if($('#bx-pager-left-image-panel').find('img').length > 0 ){
                    $('#bx-pager-left-image-panel').find('img').each(function(){
                        chkImage = $(this).attr('src');
                        if( typeof chkImage == 'undefined' || chkImage == '' ){
                            chkImage = $(this).attr('lazySrc');
                        }
                        if( typeof chkImage != 'undefined' && chkImage != '' ){
                            more_images.push(chkImage);
                        }
